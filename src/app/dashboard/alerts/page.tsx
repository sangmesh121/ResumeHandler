      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between mb-4">
             ...
             <span className="text-sm bg-white/10 px-3 py-1 rounded-full text-gray-300">2 Active</span>
          </div>
          
          <div className="glass-panel p-6 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between border-l-4 border-l-blue-500 gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Tracking: AI Research, MLOps, Product</p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="glass-panel p-5 rounded-2xl relative overflow-hidden group">
            ...
            <p className="text-xs text-purple-400 font-bold mb-2 flex items-center gap-1"><Zap className="w-3 h-3"/> Just Now</p>
            <h4 className="font-bold text-md mb-1">OpenAI posted 3 new roles</h4>
            <p className="text-sm text-gray-400 mb-4">Roles match your profile at 87%. Would you like to generate highly optimized resumes?</p>
